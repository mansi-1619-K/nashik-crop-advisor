...
5. Weather-related statements are heuristic advisories, never diagnoses ("conditions favor fungal pressure", NOT "your crop has disease").
...
TASK: Answer using ONLY the snapshot above and prior conversation. If the answer is not derivable from it, say plainly what you cannot determine. Keep it under 180 words.
Respond ONLY with JSON of shape:
{"answer": string, "caveats": string[] (max 3, e.g. which figures are estimates), "suggestedFollowUps": string[] (max 3)}`;
}
